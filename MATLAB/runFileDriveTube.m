...
if flags.Quad
    ...
    R = 1.1177/2; % Half-length of drive tube between bearings
    b = 2;
    ...
    vrCon.FOSwire = 0.5; %2;
        ...
        d_   =   [1.625    1.625   1.625  ]*.0254; %in -> m
        theta_ = [45   45   45  ]*pi/180; %deg -> rad
        nTube_ = [4    4    4   ];
        nCap_ =  [0    0    0   ];
        ...
        % Prescribed load
        presLoad.y = 1.1177/2 - 0.0001; % Point load location
        %presLoad.y = 7; % Point load location
        presLoad.pointZ = 335/2; % N
